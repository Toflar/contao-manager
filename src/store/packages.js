        ...
        setInstalled(state, { root, local: packages, missing }) {
            ...
            if (root) {
                Object.keys(root.require).forEach((name) => {
                    ...
                    if (!Object.prototype.hasOwnProperty.call(installed, name) && !Object.prototype.hasOwnProperty.call(required, name)) {
        ...
        apply({ state, dispatch }, options = { dry_run: false, update_all: false }) {
            ...
            Object.keys(features).forEach((pkg) => {
                Object.keys(features[pkg]).forEach((feature) => {
                    ...
                    if (!Object.prototype.hasOwnProperty.call(require, feature)) {
                        return;
                    }
                    ...
                    if (!Object.prototype.hasOwnProperty.call(require, pkg) && state.root?.require[pkg]) {
                        require[feature] = state.root.require[pkg];
                    } else if (Object.prototype.hasOwnProperty.call(require, pkg)) {
                        require[feature] = require[pkg];
                    }
                });
            });
